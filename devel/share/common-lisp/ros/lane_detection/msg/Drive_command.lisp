...
(cl:defmethod cl:initialize-instance :after ((m <Drive_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Drive_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lane_detection-msg:<Drive_command> is deprecated: use lane_detection-msg:Drive_command instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Drive_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detection-msg:speed-val is deprecated.  Use lane_detection-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Drive_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detection-msg:angle-val is deprecated.  Use lane_detection-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <Drive_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_detection-msg:flag-val is deprecated.  Use lane_detection-msg:flag instead.")
  (flag m))
