...
(cl:defmethod cnt-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:cnt-val is deprecated.  Use obstacle_detector-msg:cnt instead.")
  (cnt m))

(cl:ensure-generic-function 'x_arr-val :lambda-list '(m))
(cl:defmethod x_arr-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:x_arr-val is deprecated.  Use obstacle_detector-msg:x_arr instead.")
  (x_arr m))

(cl:ensure-generic-function 'y_arr-val :lambda-list '(m))
(cl:defmethod y_arr-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:y_arr-val is deprecated.  Use obstacle_detector-msg:y_arr instead.")
  (y_arr m))
