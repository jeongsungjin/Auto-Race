...
(cl:defmethod cl:initialize-instance :after ((m <Drive_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Drive_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacle_detector-msg:<Drive_command> is deprecated: use obstacle_detector-msg:Drive_command instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Drive_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:speed-val is deprecated.  Use obstacle_detector-msg:speed instead.")
  (speed m))
...
(cl:defmethod flag-val ((m <Drive_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detector-msg:flag-val is deprecated.  Use obstacle_detector-msg:flag instead.")
  (flag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Drive_command>)))
  ...
  "obstacle_detector/Drive_command")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Drive_command)))
  "Returns string type for a message object of type 'Drive_command"
  "obstacle_detector/Drive_command")
