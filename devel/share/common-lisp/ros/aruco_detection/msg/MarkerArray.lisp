...
(cl:defmethod cl:initialize-instance :after ((m <MarkerArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MarkerArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aruco_detection-msg:<MarkerArray> is deprecated: use aruco_detection-msg:MarkerArray instead.")))
...
(cl:defmethod poses-val ((m <MarkerArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_detection-msg:poses-val is deprecated.  Use aruco_detection-msg:poses instead.")
  (poses m))
