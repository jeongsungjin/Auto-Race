...
class ParkingSingDetection:
    def __init__(self):
        ...
        try:
            ...
            cv2.createTrackbar('H_min_blue', 'BLUE Trackbars', 100, 179, self.nothing)
            cv2.createTrackbar('H_max_blue', 'BLUE Trackbars', 130, 179, self.nothing)
            cv2.createTrackbar('S_min_blue', 'BLUE Trackbars', 50, 255, self.nothing)
            cv2.createTrackbar('S_max_blue', 'BLUE Trackbars', 255, 255, self.nothing)
            cv2.createTrackbar('V_min_blue', 'BLUE Trackbars', 50, 255, self.nothing)
    ...
    def detect_blue(self, image):
        ...
        frame_cropped = frame_resized[270:331, 325:]  # y from 270 to 330, x from 325 to the end
        ...
        # if blue_pixel_counts > 800 and self.tunnel_done_flag == True:
        #     self.is_blue_msg.data = True
        # else:
        #     self.is_blue_msg.data = False
