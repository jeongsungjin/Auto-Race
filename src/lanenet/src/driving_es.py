...
def bird_eye_view(img,width,height):
    ...
    dst = np.float32([[0,0],
                  [width,0],
                  [0,height],
                  [640,height]])   #src, dst는 모두 순서대로 왼쪽위, 오른쪽위, 왼쪽아래, 오른쪽 아래 점입니다.230, 415
...
def region_of_interest(img):
    ...
    pts = np.array([[0,0],[560,0],[560,480],[0,480]])  # 차례대로 왼쪽위, 오른쪽위, 오른쪽아래,왼쪽아래 점이며 저희는 하나의 차선만 인식되어도 안정적으로 주행할 수 있도록 구현하였기에 roi를 보수적으로 설정하여 노이즈를 가능한 줄여주었습니다.
